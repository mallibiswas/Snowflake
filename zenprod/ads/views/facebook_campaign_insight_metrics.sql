CREATE OR REPLACE VIEW ZENPROD.ADS.FACEBOOK_CAMPAIGN_INSIGHT_METRICS COMMENT='IN DEVELOPMENT 2020-07-16 - unified ads reporting view for camapaign-level metrics such as impressions, clicks & spend reported daily'
AS
