CREATE OR REPLACE VIEW ZENPROD.ADS.AD_WALKTHROUGHS COMMENT='IN DEVELOPMENT 2020-07-16 - unified ads reporting view for ad-level metrics such as impressions, clicks & spend reported daily'
AS

with facebook_ad_walkthroughs_ as (
    select
        ad_account_id
        , campaign_id
        , ad_set_id
...
select * from facebook_ad_walkthroughs_ union all select * from liveramp_ad_walkthroughs_;
