CREATE OR REPLACE VIEW ZENPROD.ADS.FACEBOOK_AD_SET_INSIGHT_METRICS COMMENT='IN DEVELOPMENT 2020-07-16 - unified ads reporting view for ad set level metrics such as impressions, clicks & spend reported daily'
AS
with all_dates_ as (
