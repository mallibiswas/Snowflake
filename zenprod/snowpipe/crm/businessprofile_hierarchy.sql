CREATE OR REPLACE view ZENPROD.CRM.BUSINESSPROFILE_HIERARCHY
...
from zenprod.crm.portal_businessprofile where parent_id is null) Q1
LEFT OUTER JOIN
...
where parent_id in (select business_id from zenprod.crm.portal_businessprofile where parent_id is null)
...
where parent_id in (select business_id
                    from zenprod.crm.portal_businessprofile
                    where parent_id in
                    (select business_id from zenprod.crm.portal_businessprofile where parent_id is null))
...
from zenprod.crm.portal_businessprofile
where parent_id in (
select business_id from zenprod.crm.portal_businessprofile
where parent_id in (select business_id
                    from zenprod.crm.portal_businessprofile
                    where parent_id in
                          (select business_id from zenprod.crm.portal_businessprofile where parent_id is null))
