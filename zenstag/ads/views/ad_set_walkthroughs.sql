CREATE OR REPLACE VIEW ZENSTAG.ADS.AD_SET_WALKTHROUGHS COMMENT='IN DEVELOPMENT 2020-07-16 - unified ads reporting view for ad set level metrics such as impressions, clicks & spend reported daily'
AS
...
, ad_set_date_range_ as (
  ...
  from zenstag.ads.ad_set_insights i
...
, ad_set_walkthroughs_after_2019_11_15_ as (
  ...
  left join zenstag.ads.ad_set_insights i 
...
, custom_conversion_ad_set_insights_ as (
  ...
  from zenstag.ads.ad_set_insights_custom_conversions aiicc
  left join zenstag.ads.ad_sets a on aiicc.ad_set_id = a.ad_set_id
