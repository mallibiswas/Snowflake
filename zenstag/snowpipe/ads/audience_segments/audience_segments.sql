...
create or replace procedure ZENSTAG.ADS.AUDIENCE_SEGMENTS_PROCEDURE(FILE_DATE STRING)
returns boolean
language javascript
strict
as
$$
    snowflake.createStatement({ 
      sqlText: `
          create or replace transient table ZENSTAG.ADS.AUDIENCE_SEGMENTS as
...
create task ZENSTAG.ADS.AUDIENCE_SEGMENTS_TASK
    WAREHOUSE = ZENSTAG
    SCHEDULE = 'USING CRON 0 0 * * * UTC'
as 
    CALL ZENSTAG.ADS.AUDIENCE_SEGMENTS_PROCEDURE(CURRENT_DATE());

alter task ZENSTAG.ADS.AUDIENCE_SEGMENTS_TASK resume;
