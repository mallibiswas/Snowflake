CREATE OR REPLACE VIEW AD_INSIGHT_METRICS COMMENT='IN DEVELOPMENT 2020-07-16 - unified ads reporting view for ad-level metrics such as impressions, clicks & spend reported daily'
AS
...
, ad_names_ as (
  ...
  from zenalytics.ads_campaigns.ads
)
, campaign_goals_ as (
  select
    zcr.campaign_id
