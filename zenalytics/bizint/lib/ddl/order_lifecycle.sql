...
from &{sourcedb}.RECURLY.recurly_subscriptions rs
where state <> 'future'; 
...
from all_recurly_subscriptions_ a,
     &{sourcedb}.RECURLY.recurly_plans p
...
where contract_state = 'CLOSED' and b.subscription_state = 'CLOSED'
and a.beta = False
...
inner join &{sourcedb}.AMS.account ac on a.account_id = ac.account_id
inner join &{sourcedb}.AMS.subscriptions_v2 b on a.account_id = b.account_id and a.contract_id = b.contract_id
...
v1.*,
nvl(recurly_monthly_subscription_service_fee,ams_monthly_subscription_service_fee) as monthly_subscription_service_fee
...
or contract_sent_date = contract_cancelled_date;
-- or datediff(minute,contract_sent_date,contract_cancelled_date) <= 1;
