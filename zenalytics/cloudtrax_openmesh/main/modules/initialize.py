...
class readConfigFile():
    ...
    def __init__(self):
        ...
        self.CLOUDTRAX_OPENMESH_KEY = cipher.decrypt(base64.b64decode(self.configs['Connections']['Cloudtrax_openmesh_key'])).strip().decode('ascii')
        self.CLOUDTRAX_OPENMESH_SECRET = cipher.decrypt(base64.b64decode(self.configs['Connections']['Cloudtrax_openmesh_secret'])).strip().decode('ascii')
